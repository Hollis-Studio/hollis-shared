 ...
 */
type SnakeCase<S extends string> = S extends `${infer T}-${infer U}` ? `${Lowercase<T>}_${SnakeCase<U>}` : Lowercase<S>;
/**
 ...
 * ```
 */
export declare function createEnumContract<T extends readonly [string, ...string[]]>(values: T, options?: EnumContractOptions<T>): EnumContract<T>;
/**
 * Extracts the tuple values from an enum contract.
 * Useful for backward compatibility when you need just the tuple.
 */
export declare function getEnumValues<T extends NonEmptyTuple>(contract: EnumContract<T>): T;
/**
...
export {};
//# sourceMappingURL=enumContract.d.ts.map