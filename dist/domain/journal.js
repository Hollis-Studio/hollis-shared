...
export const JOURNAL_MOOD_LABELS = {
...
export const JOURNAL_ENERGY_LABELS = {
    very_low: "Very Low",
    low: "Low",
    medium: "Medium",
    high: "High",
...
export const PLAN_ADHERENCE_VALUES = ["Yes", "Mostly", "No"];
 ...
 */
export const journalListResponseSchema = createPaginatedListSchema(journalEntrySchema);
// ============================================================================
...
export const createMockJournalAIAssessment = (overrides = {}) => ({
