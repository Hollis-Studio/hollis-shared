 ...
 */
export const eventMetadataSchema = z.record(z.string(), z.union([z.string(), z.number(), z.boolean(), z.null()]));
/**
 ...
 */
export const foodEntriesRecordSchema = z.record(z.string(), z.array(foodLogEntrySchema));
// ============================================================================
...
//# sourceMappingURL=json-blobs.js.map