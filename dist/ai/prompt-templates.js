 ...
 */
export function buildWorkoutUserPrompt(formattedContext, weekStartDate, customPrompt, _overwriteMode) {
 ...
 * @returns Complete user prompt for AI
 */
export function buildNutritionUserPrompt(formattedContext, weekStartDate, customPrompt) {
    let prompt = `Here is the client context for the week starting ${weekStartDate}:\n\n${formattedContext}`;
    if (customPrompt) {
        prompt += `\n\n## Additional Instructions from Staff:\n${customPrompt}`;
    }
 ...
 * @returns Complete user prompt for AI
 */
export function buildStrategyUserPrompt(formattedContext, customPrompt) {
 ...
 */
export function buildClarificationAnswerPrompt(clarificationAnswers) {
