...
export function getFeaturedProducts() {
    return PRODUCT_CATALOG.filter((p) => p.isFeatured && p.isAvailable).sort((a, b) => a.sortOrder - b.sortOrder);
}
/**
 ...
 */
export function getProductsByCategory(category, { includeUnavailable = false } = {}) {
    return PRODUCT_CATALOG.filter((p) => p.category === category && (includeUnavailable || p.isAvailable)).sort((a, b) => a.sortOrder - b.sortOrder);
}
/**
