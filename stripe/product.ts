...
export const PRODUCT_CATALOG: Product[] = [
  {
    ...
    description:
      "Our pharmaceutical-grade fish oil provides 2000mg of EPA/DHA per serving. Sourced from wild-caught fish, molecularly distilled for purity, and third-party tested for heavy metals.",
  ...
  },
  {
    ...
    description:
      "Creapure® creatine monohydrate - the gold standard for muscle strength, power, and recovery. 5g per serving, unflavored for easy mixing.",
    category: "SUPPLEMENTS",
  ...
  },
  {
    ...
    description:
      "Hydrolyzed collagen peptides from grass-fed, pasture-raised cattle. Supports skin elasticity, joint health, and gut integrity. Dissolves easily in any beverage.",
    category: "SUPPLEMENTS",
  ...
  },
  {
    ...
    description:
      "Cold-processed whey protein isolate with 25g protein, <1g sugar, and no artificial sweeteners. Grass-fed, hormone-free, and easy to digest.",
    category: "SUPPLEMENTS",
  ...
  },
  {
    ...
    description:
      "5000 IU Vitamin D3 with 100mcg K2 (MK-7) for optimal calcium metabolism. Essential for bone density, immune function, and cardiovascular health.",
    category: "SUPPLEMENTS",
  ...
  },
  {
    ...
    description:
      "Chelated magnesium glycinate for superior absorption and minimal digestive discomfort. Supports sleep quality, muscle relaxation, and stress response.",
    category: "SUPPLEMENTS",
  ...
  },
  {
    ...
    description:
      "Science-backed electrolyte formula with sodium, potassium, and magnesium. No sugar, no artificial colors. Perfect for training, fasting, or daily hydration.",
    category: "SUPPLEMENTS",
...
export function getFeaturedProducts(): Product[] {
  return PRODUCT_CATALOG.filter((p) => p.isFeatured && p.isAvailable).sort(
