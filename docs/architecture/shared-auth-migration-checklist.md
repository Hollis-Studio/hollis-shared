...
| Workouts backend        | Sibling `hollis-workouts-server/` exists and typechecks with a minimal `@hollis-studio/auth-client`-style middleware for `hollis-workouts` audience, but it is still skeletal and untested. <!-- UNVERIFIED: cannot confirm from hollis-shared — would need to inspect Hollis-Workouts repo -->                                                                                                                                                                                                                                                                                               | Add real resource routes, normalize package naming to `@hollis-studio/*`, add service-token support, and cover auth errors/wrong audiences.                                                                 |
