...
Health, Workouts, and Identity now consume these packages through semver dependencies and GitHub Packages auth. Sibling `file:../hollis-shared` refs, `git+...#tag&path=...` refs, and Workouts vendored package copies are historical only.
...
│   └── vendor-hollis-interim.md                Phase H vendoring of @hollis-studio/* into Workouts
├── research/
