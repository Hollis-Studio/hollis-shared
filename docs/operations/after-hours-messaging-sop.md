...
## 1. Clinic Hours and After-Hours Definition

**Current clinic hours:** To be posted at the clinic and on hollis.health. Until formally published, operating hours are assumed to be Monday–Friday, 8:00 AM–5:00 PM CT.

**After-hours:** Any time outside of those windows, including weekends and holidays.

---

## 2. Response SLA

| Channel | During Hours | After Hours |
|---|---|---|
| Secure message (app) | 2 hours | Next business day by noon |
| Email (isaac@hollis.health) | 2 hours | Next business day by noon |
...
Record this as your outgoing voicemail message:
...
>
> If you are experiencing a medical emergency — including chest pain, difficulty breathing, stroke symptoms, or any life-threatening situation — please call 911 or go to the nearest emergency room immediately.
>
> For urgent but non-emergency concerns that cannot wait, please call (210) 891-9005 and leave a voicemail.
>
> — Isaac, Hollis Health"
...
- The Membership Agreement (Section 2.3 and Section 5.4) clarifies that Hollis is a wellness company, not an emergency provider.
- Patients are directed to 911 or the ER for any after-hours emergency.

**Future state:** If Isaac enters a call-coverage agreement with another licensed provider, this section must be updated with that provider's name, contact number, and the conditions under which patients should contact them.

---

## 5. Emergency Redirect Language

Use this language consistently across all channels (voicemail, auto-reply, in-person, on the website):

> "If you are experiencing a medical emergency, call 911 or go to your nearest emergency room. Hollis Health does not provide emergency medical services."

DO NOT suggest that patients call Isaac's cell phone for emergencies. DO NOT promise same-day clinical response after hours. DO NOT imply that your voicemail is monitored continuously.

---

## 6. Documenting After-Hours Messages

When you review messages the next business day:
1. Respond to all pending messages within the SLA.
2. For any message that described a clinical concern, note your response in the patient's chart.
3. If a patient messaged about an emergency after hours and did not get a timely response, address it directly: "I see you sent a message about [concern]. I hope you were able to get the help you needed. Please let me know how I can follow up."

---

## 7. Holidays and Extended Closures
