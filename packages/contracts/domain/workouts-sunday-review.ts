 ...
 */
export const WORKOUTS_BODY_REGIONS = ["chest", "back", "arms", "shoulders", "core", "legs"] as const;
...
} as const satisfies Record<SundayReviewSlideType, z.ZodType>;
 ...
 */
export const WEEK_CLIENT_SNAPSHOT_SCHEMA_VERSION = 3 as const;
...
export const SUNDAY_REVIEW_MODEL_TIERS = ["flash", "pro", "image"] as const;
