...
export const SPONSORED_PANEL_STATUS = {
  ...
  DECLINED: "DECLINED",
  LAPSED: "LAPSED",
} as const satisfies Record<SponsoredPanelStatus, SponsoredPanelStatus>;

export const DEFAULT_SPONSORED_PANEL_STATUS: SponsoredPanelStatus =
  SPONSORED_PANEL_STATUS.NOT_ENROLLED;

/** Human-readable labels for sponsorship status */
export const SPONSORED_PANEL_STATUS_LABELS: Record<SponsoredPanelStatus, string> = {
...
export const SPONSORED_PANEL_TIERS: readonly UserTier[] = [
  USER_TIER.CORE,
  USER_TIER.CONCIERGE,
];

/** Whether a tier is eligible for Hollis-sponsored panel membership. */
export function isSponsoredPanelTier(tier: UserTier): boolean {
