...
export const clientIntakePayloadSchema = z.object({
  ...
  pastMedicalHistoryConditions:
    patientIntakeV1BodySchema.shape.pastMedicalHistoryConditions,
  pastMedicalHistoryOther:
    patientIntakeV1BodySchema.shape.pastMedicalHistoryOther,
...
export type AdminLeadConvertByEmailBody = z.infer<
  typeof adminLeadConvertByEmailBodySchema
>;
...
export type AdminLeadConvertByEmailResponse = z.infer<
  typeof adminLeadConvertByEmailResponseSchema
>;
