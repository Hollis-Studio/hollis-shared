...
│   ├── billing.ts     # Billing statuses, subscription types
│   ├── biometrics.ts  # Biometric sources, types
...
│   ├── health-metrics.ts # Health metric types
...
│   ├── ai-validation.ts # AI function-call Zod schemas
