 ...
 */
export const PHI_ACCESS_REASON_LABELS = {
...
export const createMockPhiAuditLogEntry = (overrides = {}) => ({
    id: "audit-log-id",
    actorId: "actor-123",
    userId: "user-456",
    resource: PHI_RESOURCE.USER,
    action: PHI_ACTION.READ,
    method: "GET",
    path: "/users/user-456",
    resourceId: "user-456",
    ipAddress: "127.0.0.1",
...
//# sourceMappingURL=phi-audit.js.map