 ...
 */
export const AUTH_TOKEN_TYPES = ["access", "refresh", "mfa_pending"];
 ...
 */
export const AUDIENCES = ["hollis-health", "hollis-workouts"];
 ...
 */
export function validateAudience(claims, requiredAud) {
