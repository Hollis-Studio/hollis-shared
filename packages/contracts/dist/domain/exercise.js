...
export function isExerciseCategory(value) {
...
// TRACKING TYPES
// ============================================================================
export const TRACKING_TYPES = ["REPS", "TIME", "DISTANCE"];
...
export const EXERCISE_TRACKING_TYPES = ["REPS", "TIME", "DISTANCE"];
...
export const createMockExercise = (overrides = {}) => {
    ...
    return {
        ...
        instructions: "Set up barbell at shoulder height\nPosition bar across upper back",
...
export const createMockExerciseLog = (overrides = {}) => {
    const timestamp = nowIso();
    return {
