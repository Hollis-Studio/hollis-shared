 ...
 */
export const USER_ROLES = ["ADMIN", "CLINICIAN", "TRAINER", "CLIENT"];
...
export const DEFAULT_USER_ROLE = USER_ROLE.CLIENT;
...
export function isSiteAdminRole(role) {
    return role === USER_ROLE.ADMIN;
}
// ============================================================================
 ...
 */
export function canViewCareTeamNotes(role) {
    return role === USER_ROLE.ADMIN || role === USER_ROLE.CLINICIAN;
}
/**
 ...
 */
export function canViewLabResults(role) {
    return role === USER_ROLE.ADMIN || role === USER_ROLE.CLINICIAN;
}
/**
 ...
 */
export const USER_TIERS = ["ESSENTIALS", "CORE", "CONCIERGE"];
...
export const DEFAULT_USER_TIER = USER_TIER.ESSENTIALS;
 ...
 */
export const USER_TIER_PRICES_DOLLARS = {
...
export function isUserTier(value) {
    return USER_TIERS.includes(value);
}
// ============================================================================
// MEMBERSHIP CONTRACT
// ============================================================================
...
export const BIOLOGICAL_SEX_LABELS = {
    female: "Female",
    male: "Male",
...
export const RegistrationBiologicalSexSchema = z.enum(REGISTRATION_BIOLOGICAL_SEX_OPTIONS);
...
export const REGISTRATION_BIOLOGICAL_SEX_LABELS = {
 ...
 */
export const REGISTRATION_BIOLOGICAL_SEX_TO_BIOLOGICAL_SEX = {
 ...
 */
export function canonicalizeRegistrationBiologicalSex(value) {
    if (value == null) {
        return undefined;
    }
...
export const FITNESS_EXPERIENCE_LABELS = {
    beginner: "Beginner",
    intermediate: "Intermediate",
    advanced: "Advanced",
    expert: "Expert",
...
export const PatientAccountStatusFilterSchema = z.enum(PATIENT_ACCOUNT_STATUS_FILTERS);
 ...
 */
export function mapAccountStatusToFlags(status) {
    switch (status) {
        case "active":
            return {
                isActive: true,
 ...
 */
export function deriveAccountStatus(isActive, accountSuspended, deletedAt) {
 ...
 * `inactive` => `isActive=false` + `accountSuspended=false`.
 */
export function normalizeAccountStatusFlags(isActive, accountSuspended, deletedAt) {
    const accountStatus = deriveAccountStatus(isActive, accountSuspended, deletedAt);
    return {
        accountStatus,
 ...
 */
export function calculateTrimesterFromDueDate(dueDate, referenceDate = new Date()) {
...
export const MESSAGE_RECIPIENT_ROLE_LABELS = {
...
export const createMockUserPreferences = (overrides = {}) => {
    ...
    const base = {
        ...
        dashboardCardOrder: overrides.dashboardCardOrder ??
        ...
        hiddenDashboardCards: overrides.hiddenDashboardCards ??
 ...
 */
export const createMockUserGoals = (overrides = {}) => {
    const timestamp = nowIso();
    const base = {
        userId: overrides.userId ?? "mock-user",
 ...
 */
export const createMockUserMetrics = (overrides = {}) => ({
    tdee: 2200,
    bmr: 1700,
    recoveryScore: 75,
    trainingLoad: 250,
...
export const createMockUserAccount = (overrides = {}) => ({
...
function normalizeNutritionNotificationUpdateInput(value) {
...
function buildNotificationSection(base, candidate, updateSchema, fullSchema) {
...
export const frequencyNotificationUpdateSchema = frequencyNotificationSchema.partial();
export const nutritionNotificationUpdateSchema = z.preprocess(normalizeNutritionNotificationUpdateInput, nutritionNotificationSchema.partial());
export const adminPortalNotificationPreferencesUpdateSchema = adminPortalNotificationPreferencesSchema.partial();
export const notificationPreferencesUpdateSchema = z
    ...
    .partial()
    .strip();
export function normalizeNotificationPreferences(value, fallback = defaultNotifications()) {
    const source = isPlainObject(value) ? value : {};
    return {
        morningBriefing: buildNotificationSection(fallback.morningBriefing, source.morningBriefing, dailyNotificationUpdateSchema, dailyNotificationSchema),
        eveningCheckIn: buildNotificationSection(fallback.eveningCheckIn, source.eveningCheckIn, dailyNotificationUpdateSchema, dailyNotificationSchema),
        weeklyInsights: buildNotificationSection(fallback.weeklyInsights, source.weeklyInsights, weeklyNotificationUpdateSchema, weeklyNotificationSchema),
        coPilotCheckIns: buildNotificationSection(fallback.coPilotCheckIns, source.coPilotCheckIns, frequencyNotificationUpdateSchema, frequencyNotificationSchema),
        trainingGuidance: buildNotificationSection(fallback.trainingGuidance, source.trainingGuidance, frequencyNotificationUpdateSchema, frequencyNotificationSchema),
        nutritionCoaching: buildNotificationSection(fallback.nutritionCoaching, source.nutritionCoaching, nutritionNotificationUpdateSchema, nutritionNotificationSchema),
        adminPortal: buildNotificationSection(fallback.adminPortal, source.adminPortal, adminPortalNotificationPreferencesUpdateSchema, adminPortalNotificationPreferencesSchema),
    };
}
export function mergeNotificationPreferences(base, update) {
    const canonicalBase = normalizeNotificationPreferences(base);
    const updateSource = isPlainObject(update) ? update : {};
    return {
        morningBriefing: buildNotificationSection(canonicalBase.morningBriefing, updateSource.morningBriefing, dailyNotificationUpdateSchema, dailyNotificationSchema),
        eveningCheckIn: buildNotificationSection(canonicalBase.eveningCheckIn, updateSource.eveningCheckIn, dailyNotificationUpdateSchema, dailyNotificationSchema),
        weeklyInsights: buildNotificationSection(canonicalBase.weeklyInsights, updateSource.weeklyInsights, weeklyNotificationUpdateSchema, weeklyNotificationSchema),
        coPilotCheckIns: buildNotificationSection(canonicalBase.coPilotCheckIns, updateSource.coPilotCheckIns, frequencyNotificationUpdateSchema, frequencyNotificationSchema),
        trainingGuidance: buildNotificationSection(canonicalBase.trainingGuidance, updateSource.trainingGuidance, frequencyNotificationUpdateSchema, frequencyNotificationSchema),
        nutritionCoaching: buildNotificationSection(canonicalBase.nutritionCoaching, updateSource.nutritionCoaching, nutritionNotificationUpdateSchema, nutritionNotificationSchema),
        adminPortal: buildNotificationSection(canonicalBase.adminPortal, updateSource.adminPortal, adminPortalNotificationPreferencesUpdateSchema, adminPortalNotificationPreferencesSchema),
    };
}
// ============================================================================
...
// HELPER UTILITIES
// ============================================================================
export const buildVisibilityMap = (order, hidden, existing) => order.reduce((acc, id) => {
