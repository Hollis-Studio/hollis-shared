...
export const CLINICAL_METRIC_CATEGORY_LABELS = {
...
export const CLINICAL_METRIC_DIRECTION_LABELS = {
...
export const CLINICAL_VALUE_TYPE_LABELS = {
    numeric: "Numeric",
    ratio: "Ratio",
    qualitative: "Qualitative",
    calculated: "Calculated",
...
export const CLINICAL_AGE_BRACKET_LABELS = {
...
export const CLINICAL_PREGNANCY_STATUS_LABELS = {
...
export const CLINICAL_MODIFIER_LOGIC_LABELS = {
...
export const ClinicalMetricDefinitionSchema = z
    ...
    if (data.optimalRange) {
        if (data.optimalRange.min !== undefined &&
        ...
        if (data.optimalRange.max !== undefined &&
    ...
    for (const [metricKey, definition] of Object.entries(data.metrics)) {
        ...
        if (definition.parentPanelKey) {
            if (!(definition.parentPanelKey in data.metrics)) {
                ...
                if (!parentMetric.panelComponents ||
 ...
 */
export function isClinicalMetricCategory(value) {
    return CLINICAL_METRIC_CATEGORIES.includes(value);
}
/**
 * Type guard to check if a string is a valid clinical metric direction.
 */
export function isClinicalMetricDirection(value) {
    return CLINICAL_METRIC_DIRECTIONS.includes(value);
}
/**
 * Type guard to check if a string is a valid clinical value type.
 */
export function isClinicalValueType(value) {
    return CLINICAL_VALUE_TYPES.includes(value);
}
/**
 * Type guard to check if a string is a valid clinical age bracket.
 */
export function isClinicalAgeBracket(value) {
    return CLINICAL_AGE_BRACKETS.includes(value);
}
/**
 * Type guard to check if a string is a valid clinical sex.
 */
export function isClinicalSex(value) {
    return CLINICAL_SEXES.includes(value);
}
/**
 * Type guard to check if a string is a valid clinical pregnancy status.
 */
export function isClinicalPregnancyStatus(value) {
    return CLINICAL_PREGNANCY_STATUSES.includes(value);
}
/**
 * Type guard to check if a string is a valid clinical modifier logic type.
 */
export function isClinicalModifierLogic(value) {
    return CLINICAL_MODIFIER_LOGIC_TYPES.includes(value);
}
/**
 * Type guard to check if a string is a valid camelCase metric key.
 */
export function isClinicalMetricKey(value) {
 ...
 */
export function parseClinicalMetricRegistry(data) {
 ...
 */
export function safeParseClinicalMetricRegistry(data) {
 ...
 */
export function parseClinicalMetricDefinition(data) {
 ...
 * @returns Safe parse result with success flag and data/error
 */
export function safeParseClinicalMetricDefinition(data) {
    return ClinicalMetricDefinitionSchema.safeParse(data);
}
//# sourceMappingURL=clinical-registry.schema.js.map