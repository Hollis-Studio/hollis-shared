 ...
 */
export function getComplianceStatusFromScore(score) {
    ...
    if (score >= COMPLIANCE_THRESHOLDS.AT_RISK)
        return COMPLIANCE_STATUS.AT_RISK;
...
export function isComplianceStatus(value) {
    return COMPLIANCE_STATUSES.includes(value);
}
// ============================================================================
// COMPLIANCE METRICS
// ============================================================================
 ...
 */
export const TIER_COMPLIANCE_REQUIREMENTS = {
    ESSENTIALS: {
        checkinsPerWeek: 1,
        foodLogsPerWeek: 0,
        workoutsPerWeek: 1,
 ...
 */
export const TIER_COMPLIANCE_THRESHOLDS = {
    ESSENTIALS: {
...
export const ComplianceEngineInputSchema = z.object({
    tier: z.enum(["ESSENTIALS", "CORE", "CONCIERGE"]),
...
export const ComplianceEngineResultSchema = z.object({
    ...
    status: z.enum(["excellent", "good", "at-risk", "non-compliant"]),
    tier: z.enum(["ESSENTIALS", "CORE", "CONCIERGE"]),
...
// MOCK FACTORIES
// ============================================================================
export function createMockMetricAdherence(overrides = {}) {
    return {
        actual: 5,
        expected: 7,
        adherence: 71,
...
export function createMockComplianceBreakdown(overrides = {}) {
    return {
...
export function createMockTierAwareComplianceResult(overrides = {}) {
    return {
