...
export const AI_NOTE_CATEGORY_LABELS = {
    INJURY: "Injury",
    PREFERENCE: "Preference",
    LIMITATION: "Limitation",
    MEDICAL: "Medical",
...
export const AI_NOTE_SOURCE_TYPE_LABELS = {
 ...
 */
export function isAINoteSourceType(value) {
    return AI_NOTE_SOURCE_TYPES.includes(value);
}
/**
 * Get the label for an AI note source type, with fallback
 */
export function getAINoteSourceTypeLabel(sourceType) {
 ...
 */
export function isAINoteCategory(value) {
    return AI_NOTE_CATEGORIES.includes(value);
}
/**
 * Get the label for an AI note category, with fallback
 */
export function getAINoteCategoryLabel(category) {
 ...
 */
export const createMockWorkoutSessionNote = (overrides = {}) => {
 ...
 */
export const createMockAIPermanentNote = (overrides = {}) => {
    const timestamp = nowIso();
    return {
        id: overrides.id ??
 ...
 */
export const createMockAIContext = (overrides = {}) => {
    const timestamp = nowIso();
    return {
        userId: overrides.userId ?? "mock-user",
