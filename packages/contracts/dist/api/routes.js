...
export { AUTH_ROUTES } from "./routes/auth.js";
...
export const DOCUMENTS_ROUTES = {
     ...
     */
    get: (documentId) => `/api/documents/${documentId}`,
    /**
...
export const PHI_ROUTES = {
     ...
     */
    metricTrend: (metricCode) => `/phi/trends/${metricCode}`,
    // --- Care Team / Providers ---
 ...
 * ```
 */
export function getRoutePattern(path) {
 ...
 * ```
 */
export function buildUrlWithQuery(basePath, params) {
